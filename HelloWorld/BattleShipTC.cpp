...
bool BattleShipTC::Shoot(int InX, int InY)
{
...
void BattleShipTC::PrintGameState() const
{
	if (IsTestMode)
	{
...
void BattleShipTC::PrintGameResult() const
{
